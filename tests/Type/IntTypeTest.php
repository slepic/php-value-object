...
final class IntTypeTest extends TestCase
{
    ...
    public function testTypeExpectation(): void
    {
        ...
        self::assertTrue($expectation->acceptsInt());
    ...
    public function testIntSuccess(): void
    {
        self::assertSame(10, $this->type->prepareValue(10));
    }

    public function testConvertibleToIntSuccess(): void
    {
        ...
        self::assertSame(10, $this->type->prepareValue($input));
    }

    public function testConvertibleToIntWithoutInterfaceFails(): void
    {
        $input = new class () {
            public function toInt(): int
            {
